...
//             block.time = new Date().getTime().toString().slice(0,-3); if(self.chain.length>0){
...
//     //             };
//     //             const isPreviousBlockHash = await block.previousBlockHash;
//     //                 if (block.hash != isPreviousBlockHash){
